...
const faqs = [
  ...
  },
  {
    ...
    answer: "Estate planning costs in Malaysia vary based on complexity. Basic will writing starts from RM 2,500. Complete estate planning packages including trusts range from RM 6,500 to RM 15,000+. Our tech-powered approach reduces costs by 30-50% compared to traditional methods while maintaining quality. We offer transparent pricing with no hidden fees."
  },
  {
  ...
  },
  {
    ...
    answer: "A will takes effect after death and requires probate (court approval), which can take 6-24 months. A living trust is effective immediately, avoids probate, provides privacy, and offers better asset protection. Trusts are ideal for estates over RM 2 million, business owners, or those wanting sophisticated tax planning. We recommend trusts through RHB Trustee Bhd for professional management."
  },
  {
  ...
  {
    question: "Why choose Estate Wealth My for estate planning?",
    answer: "We're Malaysia's first tech-powered estate planning service. Advantages: 1) Complete in 2 weeks (not 2 months) 2) 80% done online 3) Only 1 meeting required 4) 30-50% lower cost 5) RHB Trustee partnership 6) 500+ families protected 7) 4.9/5 rating 8) Transparent pricing from RM 2,500 9) Free consultation 10) Lifetime document updates. We combine technology efficiency with personalized expert guidance."
  }
];
